        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("EmailValidCheck", "Email like '_%@_%._%'");
                    table.CheckConstraint("PhoneValidCheck", "Phone like '01%' and Phone not like '%[^0-9]%'");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("EmailValidCheck1", "Email like '_%@_%._%'");
                    table.CheckConstraint("PhoneValidCheck1", "Phone like '01%' and Phone not like '%[^0-9]%'");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("SessionStartEndConstraint", "StartTime < EndTime");
                    table.ForeignKey(
