...
namespace GymManagementDAL.Migrations
{
    ...
    [Migration("20251012125804_InitialCreate")]
                    ...
                    b.ToTable("Members", t =>
                        {
                            ...
                            t.HasCheckConstraint("PhoneValidCheck", "Phone like '01%' and Phone not like '%[^0-9]%'");
                        });
                });
                    ...
                    b.ToTable("Sessions", t =>
                        {
                            ...
                            t.HasCheckConstraint("SessionStartEndConstraint", "StartTime < EndTime");
                        });
                });
